            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.teal[100], // Warna latar belakang container nama
                  borderRadius: BorderRadius.circular(8.0), // Membuat sudut rounded
                  boxShadow: [
                    BoxShadow(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.orange[100], // Warna latar belakang container email
              ...
              Container(
                ...
                margin: const EdgeInsets.only(bottom: 10.0),
                decoration: BoxDecoration(
                  color: Colors.lightBlue[100], // Warna latar belakang container telepon
                  borderRadius: BorderRadius.circular(8.0),
                ),
                child: const Row(
                  children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.green[100], // Warna latar belakang container alamat
                  borderRadius: BorderRadius.circular(8.0),
                ),
                child: const Column( // Menggunakan Column untuk alamat yang mungkin lebih dari 1 baris
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 5),
                    Padding(
                      padding: EdgeInsets.only(left: 34.0), // Indentasi untuk teks alamat
                      child: Text(
